* Pinebook Pro Kernel Compilation (debian)

** Preface
Here's how to compile [1]tsys' mainline linux kernel for the Pinebook Pro.
...
According to [2]this post, you can update your initrd to include modules to decrypt the file system, but the display won't work.
...
References
1. https://gitlab.manjaro.org/tsys/linux-pinebook-pro
2. https://forum.pine64.org/showthread.php?tid=8765
