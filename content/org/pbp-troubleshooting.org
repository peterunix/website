   Unixfandom.com penguin_gif

Troubleshooting PBP problems
...
Can't boot at all after flashing EMMC
   ...
   happen).
   Once opened, flip the emmc switch to disable the emmc ([1]reference).
...
References
   ...
   1. https://wiki.pine64.org/wiki/Pinebook_Pro#Key_Internal_Parts
